...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NewsGuard — Fake News Detector for Students" },
      { name: "description", content: "Analyze articles for credibility, verify claims, and learn to spot misinformation." },
      { property: "og:title", content: "NewsGuard — Fake News Detector for Students" },
      { property: "og:description", content: "Analyze articles for credibility, verify claims, and learn to spot misinformation." },
